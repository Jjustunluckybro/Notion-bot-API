...
@router.post(
    "/get_all_notes_by_condition", status_code=status.HTTP_200_OK)  # TODO: What with post method, need "get", but in get can not use body
...
@router.post("/set_new_note", status_code=status.HTTP_200_OK)
